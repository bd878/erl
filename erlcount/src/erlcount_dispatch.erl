...
dispatching({continue, File, Continuation}, Data = #data{regex=Re, refx=Refs}) ->
...
dispatching(done, Data) ->
  ...
  %% been received by the time we hit 'done'.
  %% As such, we directly move to
